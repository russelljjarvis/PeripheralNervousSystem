...
#define nrn_init _nrn_init__hdmin73
#define _nrn_initial _nrn_initial__hdmin73
#define nrn_cur _nrn_cur__hdmin73
#define _nrn_current _nrn_current__hdmin73
#define nrn_jacob _nrn_jacob__hdmin73
#define nrn_state _nrn_state__hdmin73
#define _net_receive _net_receive__hdmin73 
#define rates rates__hdmin73 
#define states states__hdmin73 
...
extern Memb_func* memb_func;
 ...
 "setdata_hdmin73", _hoc_setdata,
 "rates_hdmin73", _hoc_rates,
 0, 0
};
 ...
 "gmax_hdmin73", "S/cm2",
 "conductance_hdmin73", "uS",
 "l_timeCourse_TIME_SCALE_hdmin73", "ms",
 "l_timeCourse_VOLT_SCALE_hdmin73", "mV",
 "l_steadyState_TIME_SCALE_hdmin73", "ms",
 "l_steadyState_VOLT_SCALE_hdmin73", "mV",
 "l_q10Settings_experimentalTemp_hdmin73", "K",
 "l_q10Settings_TENDEGREES_hdmin73", "K",
 "gion_hdmin73", "S/cm2",
 "l_timeCourse_t_hdmin73", "ms",
 "l_tauUnscaled_hdmin73", "ms",
 "l_tau_hdmin73", "ms",
 "g_hdmin73", "uS",
 0,0
};
...
"hdmin73",
 ...
 "conductance_hdmin73",
 "l_instances_hdmin73",
 "l_timeCourse_TIME_SCALE_hdmin73",
 "l_timeCourse_VOLT_SCALE_hdmin73",
 "l_timeCourse_vhalfl_hdmin73",
 "l_steadyState_TIME_SCALE_hdmin73",
 "l_steadyState_VOLT_SCALE_hdmin73",
 "l_steadyState_vhalfl_hdmin73",
 "l_q10Settings_q10Factor_hdmin73",
 "l_q10Settings_experimentalTemp_hdmin73",
 "l_q10Settings_TENDEGREES_hdmin73",
 0,
 "gion_hdmin73",
 "l_timeCourse_V_hdmin73",
 "l_timeCourse_Vhalfl_hdmin73",
 "l_timeCourse_t_hdmin73",
 "l_steadyState_V_hdmin73",
 "l_steadyState_Vhalfl_hdmin73",
 "l_steadyState_x_hdmin73",
 "l_q10Settings_q10_hdmin73",
 "l_rateScale_hdmin73",
 "l_fcond_hdmin73",
 "l_inf_hdmin73",
 "l_tauUnscaled_hdmin73",
 "l_tau_hdmin73",
 "conductanceScale_hdmin73",
 "fopen0_hdmin73",
 "fopen_hdmin73",
 "g_hdmin73",
 0,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 hdmin73 /Users/rjjarvis/Downloads/morteza/x86_64/hdmin73.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=hdmin73 type=ionChannelHH)";
