...
extern Memb_func* memb_func;
 ...
 "gmax_kap", "S/cm2",
 "conductance_kap", "uS",
 "n_forwardRate_TIME_SCALE_kap", "ms",
 "n_forwardRate_VOLT_SCALE_kap", "mV",
 "n_forwardRate_TEMP_SCALE_kap", "K",
 "n_forwardRate_TEMP_OFFSET_kap", "K",
 "n_reverseRate_TIME_SCALE_kap", "ms",
 "n_reverseRate_VOLT_SCALE_kap", "mV",
 "n_reverseRate_TEMP_SCALE_kap", "K",
 "n_reverseRate_TEMP_OFFSET_kap", "K",
 "n_timeCourse_TIME_SCALE_kap", "ms",
 "n_timeCourse_VOLT_SCALE_kap", "mV",
 "n_steadyState_TIME_SCALE_kap", "ms",
 "n_steadyState_VOLT_SCALE_kap", "mV",
 "n_q10Settings_experimentalTemp_kap", "K",
 "n_q10Settings_TENDEGREES_kap", "K",
 "l_timeCourse_TIME_SCALE_kap", "ms",
 "l_timeCourse_VOLT_SCALE_kap", "mV",
 "l_steadyState_TIME_SCALE_kap", "ms",
 "l_steadyState_VOLT_SCALE_kap", "mV",
 "l_steadyState_TEMP_SCALE_kap", "K",
 "l_steadyState_TEMP_OFFSET_kap", "K",
 "gion_kap", "S/cm2",
 "n_forwardRate_r_kap", "kHz",
 "n_reverseRate_r_kap", "kHz",
 "n_timeCourse_t_kap", "ms",
 "n_alpha_kap", "kHz",
 "n_beta_kap", "kHz",
 "n_tauUnscaled_kap", "ms",
 "n_tau_kap", "ms",
 "l_timeCourse_t_kap", "ms",
 "l_tauUnscaled_kap", "ms",
 "l_tau_kap", "ms",
 "g_kap", "uS",
 0,0
};
...
"kap",
 ...
 "conductance_kap",
 "n_instances_kap",
 "n_forwardRate_TIME_SCALE_kap",
 "n_forwardRate_VOLT_SCALE_kap",
 "n_forwardRate_TEMP_SCALE_kap",
 "n_forwardRate_TEMP_OFFSET_kap",
 "n_reverseRate_TIME_SCALE_kap",
 "n_reverseRate_VOLT_SCALE_kap",
 "n_reverseRate_TEMP_SCALE_kap",
 "n_reverseRate_TEMP_OFFSET_kap",
 "n_timeCourse_TIME_SCALE_kap",
 "n_timeCourse_VOLT_SCALE_kap",
 "n_steadyState_TIME_SCALE_kap",
 "n_steadyState_VOLT_SCALE_kap",
 "n_q10Settings_q10Factor_kap",
 "n_q10Settings_experimentalTemp_kap",
 "n_q10Settings_TENDEGREES_kap",
 "l_instances_kap",
 "l_timeCourse_TIME_SCALE_kap",
 "l_timeCourse_VOLT_SCALE_kap",
 "l_steadyState_TIME_SCALE_kap",
 "l_steadyState_VOLT_SCALE_kap",
 "l_steadyState_TEMP_SCALE_kap",
 "l_steadyState_TEMP_OFFSET_kap",
 "l_q10Settings_fixedQ10_kap",
 0,
 "gion_kap",
 "n_forwardRate_V_kap",
 "n_forwardRate_celsius_kap",
 "n_forwardRate_r_kap",
 "n_reverseRate_V_kap",
 "n_reverseRate_celsius_kap",
 "n_reverseRate_r_kap",
 "n_timeCourse_V_kap",
 "n_timeCourse_ALPHA_kap",
 "n_timeCourse_BETA_kap",
 "n_timeCourse_t_kap",
 "n_steadyState_V_kap",
 "n_steadyState_ALPHA_kap",
 "n_steadyState_BETA_kap",
 "n_steadyState_x_kap",
 "n_q10Settings_q10_kap",
 "n_rateScale_kap",
 "n_alpha_kap",
 "n_beta_kap",
 "n_inf_kap",
 ...
 "l_timeCourse_t_kap",
 "l_steadyState_V_kap",
 "l_steadyState_celsius_kap",
 "l_steadyState_x_kap",
 "l_q10Settings_q10_kap",
 "l_rateScale_kap",
 "l_fcond_kap",
 "l_inf_kap",
 "l_tauUnscaled_kap",
 "l_tau_kap",
 "conductanceScale_kap",
 "fopen0_kap",
 "fopen_kap",
 "g_kap",
 0,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 kap /Users/rjjarvis/Downloads/morteza/x86_64/kap.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=kap type=ionChannelHH)";
...
static int  rates ( _threadargsproto_ ) {
   ...
   n_forwardRate_r = ( ( exp ( ( 1e-3 * ( - 1.5 + ( - 1.0 ) / ( 1.0 + ( exp ( ( n_forwardRate_V - ( - 40.0 ) ) / 5.0 ) ) ) ) * ( n_forwardRate_V - 11.0 ) * 9.648e4 ) / ( 8.315 * ( 273.16 + ( n_forwardRate_celsius ) ) ) ) ) ) / n_forwardRate_TIME_SCALE ;
   ...
   n_reverseRate_r = ( ( exp ( ( 1e-3 * ( - 1.5 + ( - 1.0 ) / ( 1.0 + ( exp ( ( n_reverseRate_V - ( - 40.0 ) ) / 5.0 ) ) ) ) * 0.55 * ( n_reverseRate_V - 11.0 ) * 9.648e4 ) / ( 8.315 * ( 273.16 + ( n_reverseRate_celsius ) ) ) ) ) ) / n_reverseRate_TIME_SCALE ;
   ...
   else if ( n_timeCourse_BETA / ( 0.05 * ( 1.0 + n_timeCourse_ALPHA ) * n_rateScale ) < ( 0.1 ) ) {
     n_timeCourse_t = ( ( 0.1 * n_rateScale ) ) * n_timeCourse_TIME_SCALE ;
     }
   else {
     n_timeCourse_t = ( n_timeCourse_BETA / ( 0.05 * ( 1.0 + n_timeCourse_ALPHA ) ) ) * n_timeCourse_TIME_SCALE ;
     }
