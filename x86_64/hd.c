...
extern Memb_func* memb_func;
 ...
 "gmax_hd", "S/cm2",
 "conductance_hd", "uS",
 "l_timeCourse_TIME_SCALE_hd", "ms",
 "l_timeCourse_VOLT_SCALE_hd", "mV",
 "l_steadyState_TIME_SCALE_hd", "ms",
 "l_steadyState_VOLT_SCALE_hd", "mV",
 "l_q10Settings_experimentalTemp_hd", "K",
 "l_q10Settings_TENDEGREES_hd", "K",
 "gion_hd", "S/cm2",
 "l_timeCourse_t_hd", "ms",
 "l_tauUnscaled_hd", "ms",
 "l_tau_hd", "ms",
 "g_hd", "uS",
 0,0
...
"hd",
 ...
 "conductance_hd",
 "l_instances_hd",
 "l_timeCourse_TIME_SCALE_hd",
 "l_timeCourse_VOLT_SCALE_hd",
 "l_timeCourse_vhalfl_hd",
 "l_steadyState_TIME_SCALE_hd",
 "l_steadyState_VOLT_SCALE_hd",
 "l_steadyState_vhalfl_hd",
 "l_q10Settings_q10Factor_hd",
 "l_q10Settings_experimentalTemp_hd",
 "l_q10Settings_TENDEGREES_hd",
 0,
 "gion_hd",
 "l_timeCourse_V_hd",
 "l_timeCourse_Vhalfl_hd",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 hd /Users/rjjarvis/Downloads/morteza/x86_64/hd.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=hd type=ionChannelHH)";
